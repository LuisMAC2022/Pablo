...
class Solicitud(Base):
    """Solicitud de servicio registrada desde el formulario interno."""
...
class Usuario(Base):
    """Cuenta local autenticable con autorización basada en rol."""
    ...
    # Los roles son literales de aplicación: deben mantenerse sincronizados con
    # `app.permissions` y los scripts de alta, porque la base de datos no valida
    # el catálogo permitido.
